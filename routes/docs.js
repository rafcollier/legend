...
router.post('/submitdoc', (req, res, next) => {
  ...
  let newDoc = new Doc({
    ...
    docCollectionCode7: req.body.docCollectionCode7,    
    docCollectionCode8: req.body.docCollectionCode8,    
    ...
    code6Code: req.body.code7Code,
    code6Code: req.body.code8Code,
...
router.get('/getLayoutSearchResults', (req, res, next) => {
  ...
  Doc.aggregate([
  {
    $project:
    {
      ...
      'docCollectionCode7': 1,
      'docCollectionCode8': 1,
      'code1Code': 1,
      'code2Code': 1,
      'code3Code': 1,
      'code4Code': 1,
